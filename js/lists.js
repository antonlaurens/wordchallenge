    ...
    var ListCollections = [
        {
            ...
            lists: [
            {
                ...
                name: 'List 1',
                items: [
                    'A boy\'s name', 'Toys', 'An animal', 'Things that are cold', 'Insects', 'TV Shows', 'Things that grow', 'Fruits', 'Things that are black', 'School subjects', 'Movie titles', 'Musical Instruments'
                ]
            },
            {
                id: 1,
